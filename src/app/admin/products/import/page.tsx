      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>
            ...
            <strong>Important:</strong> Name your image files exactly as the Product SKU (e.g., if
            SKU is "GOLD-1KG", name the file "GOLD-1KG.jpg").
          </CardDescription>
        </CardHeader>
            ...
            <div className="mt-6 space-y-4">
              ...
              {csvReport.errors.length > 0 && (
                <div className="rounded border bg-red-50 p-4">
                  ...
                  <ul className="max-h-60 list-inside list-disc space-y-1 overflow-y-auto text-sm text-red-700">
